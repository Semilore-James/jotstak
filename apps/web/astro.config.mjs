...
export default defineConfig({
  ...
  integrations: [
    starlight({
      ...
      //
      // Most pages under guide/, page/, diagrams/, cookbook/ and use-cases/ are
      // still shells (draft: true) and so are absent from a production build —
      // which is also why each group below is autogenerated rather than listed
      // by hand: a group empties itself as the drafts drop out.
      sidebar: [
        {
          label: "Get started",
          items: [
        ...
        group("Diagrams", "docs/diagrams"),
        group("The page", "docs/page"),
        group("Cookbook", "docs/cookbook"),
        group("Use cases", "docs/use-cases"),
        {
          label: "Reference",
          items: [
